...
class Executer:
    ...
    _wrk_dir_name = 'wrk'
    _full_wrk_dir_path = _root_dir_name + '/' + _wrk_dir_name
    ...
    def _copy_src(self, src_data, dir_name):
        ...
        dst_full_path = self.get_full_wrk_dir_path() + '/' + dir_name
    ...
    def _copy_bin(self, src_data, dir_name):
        src_full_path = src_data.get_src_path() + '/' + src_data.get_exec_name()
        dst_full_path = self.get_full_wrk_dir_path() + '/' + dir_name + '/' + src_data.get_exec_name()
        io_manager.print_dbg_info('Copy binary file to the working directory: '
                                  + src_full_path + ' --> ' + dst_full_path)
    ...
    def _create_dir(self, dir_name):
        ...
        """
        full_path = self.get_root_dir_name() + '/' + dir_name
