...
#     print(batch_data.launcher)
#     print(batch_data.exec_name)
#     print(batch_data.exec_options)
...
#     dump_text_to_file(batch_data.script_base_name + '.sh', full_text)
...
if __name__ == '__main__':
    ...
    # batch.generate_batch_file()

    test.omp_scalability(batch, thread_range)
